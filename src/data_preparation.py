...
from config import RAW_DATA_PATH, PROCESSED_DATA_PATH, FEATURES, TARGET, GOOD_STATUS, BAD_STATUS, SAMPLE_N, RANDOM_STATE
...
def load_raw_data():
    ...
    usecols = list(set(FEATURES + ["loan_status", "issue_d"]))
